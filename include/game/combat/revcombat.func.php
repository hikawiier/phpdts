...
namespace revcombat
{
	...
	include_once GAME_ROOT.'./include/game/combat/revcombat_extra.func.php';
	include_once GAME_ROOT.'./include/game/combat/revcombat.calc.php';
	include_once GAME_ROOT.'./include/game/combat/revattr.func.php';
	include_once GAME_ROOT.'./include/game/combat/revattr.calc.php';
	include_once GAME_ROOT.'./include/game/combat/revattr_extra.func.php';
