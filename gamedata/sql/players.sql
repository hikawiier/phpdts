...
CREATE TABLE bra_players (
  ...
  extrabag_put text NOT NULL default '',
  extrabag text NOT NULL default '',
  extrabag_num smallint unsigned NOT NULL default '0',
  extrabag_max smallint unsigned NOT NULL default '0',
