...
try {
    $room->create();
    foreach (['range_test.php', 'equipment_skill_test.php', 'skill_effect_test.php', 'domain_test.php', 'battle_integration_test.php', 'transaction_integration_test.php'] as $file) {
